export const ru = {
  ...
  PaymentForm: {
    ...
    'Your card number is incomplete.': 'Поле с номером карты не заполнено.',
    "Your card's expiration date is incomplete.": 'Поле со сроком действия карты не заполнено.',
    "Your card's security code is incomplete.": 'Поле с CVC карты не заполнено.',
    'Name field is incomplete.': 'Поле с вашим именем не заполнено.',
    'Your card number is invalid.': 'Номер вашей карты некорректный.',
    "Your card's expiration year is invalid.": `Срок действия вашей карты некорректный.`,
    "Your card's expiration year is in the past.": `Срок действия вашей карты истёк.`,
  },
  Search: {
    search: 'поиск',
